    ...
    public function run()
    {
        ...
        $coconuts = ProductCategory::firstOrCreate(
            ...
            [
                'name' => 'Coconuts', 
                'status' => true,
                'hero_image' => 'images/categories/1771645551_bjjZ6HRNCx.jpeg',
        ...
        $grains = ProductCategory::firstOrCreate(
            ...
            [
                'name' => 'Grains', 
                'status' => true,
                'hero_image' => 'images/categories/RdtORrfHdc5I70fxdTqaGCLXTQHHjxasow9pQ4mQ.jpg',
        ...
        $pulses = ProductCategory::firstOrCreate(
            ...
            [
                'name' => 'Pulses', 
                'status' => true,
                'hero_image' => 'images/categories/1771645567_fu2PiX83rG.jpeg',
        ...
        $vegetables = ProductCategory::firstOrCreate(
            ...
            [
                'name' => 'Vegetables', 
                'status' => true,
                'hero_image' => 'images/categories/1772971462_HysxKF762Q.jpeg',
        ...
        $vegetablesProducts = [
            ...
            [
                ...
                'image' => 'images/products/1588252303782-cb80119abd6d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 4
            ],
            [
                'name' => 'Drumstick',
                'description' => 'Nutritious pods rich in minerals, essential for sambar and curries.',
                'image' => 'images/products/1595855726880-5b11910ef1cd?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 5
            ],
            [
                'name' => 'Okra (Ladies Finger)',
                'description' => 'Tender green pods perfect for frying and stews.',
                'image' => 'images/products/1425543103986-22abb7d7e8d2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 6
            ],
            [
                'name' => 'Brinjal (Eggplant)',
                'description' => 'Versatile purple vegetable used in diverse cuisines.',
                'image' => 'images/products/1615485925763-867862880b05?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 7
            ],
            [
                'name' => 'Cabbage',
                'description' => 'Fresh, leafy heads packed with vitamins.',
                'image' => 'images/products/1579586117180-2a5b6ce39969?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 7
            ],
            [
                'name' => 'Cauliflower',
                'description' => 'Firm, white florets ideal for steaming, roasting, or curries.',
                'image' => 'images/products/1568584711075-3d021a7c3ca3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
                'sort_order' => 8
            ]
        ];

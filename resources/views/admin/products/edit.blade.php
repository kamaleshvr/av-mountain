...
<div class="glass-card" style="max-width: 800px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid-2" style="grid-template-columns: 1fr 1fr; gap: 2rem;">
            <div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="name" id="name" required value="{{ old('name', $product->name) }}" style="width: 100%; padding: 0.8rem; border-radius: 5px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: white;">
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="tamil_name" id="tamil_name" value="{{ old('tamil_name', $product->tamil_name) }}" style="width: 100%; padding: 0.8rem; border-radius: 5px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: white;">
            ...
            <div>
                <div style="margin-bottom: 1.5rem;">
                    ...
                    @if($product->image)
                        <div style="margin-bottom: 1rem;">
                            <img src="{{ $product->image_url }}" alt="Current Image" style="max-height: 100px; border-radius: 5px;">
                        </div>
                    @endif
                ...
                <input type="hidden" name="image_base64" id="image_base64">
                 ...
                 <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $product->sort_order) }}" style="width: 100%; padding: 0.8rem; border-radius: 5px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: white;">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea name="description" id="description" rows="3" style="width: 100%; padding: 0.8rem; border-radius: 5px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: white;">{{ old('description', $product->description) }}</textarea>
        ...
        <div style="display: flex; gap: 2rem; margin-bottom: 2rem;">
            <label class="checkbox-container" style="display: flex; align-items: center; cursor: pointer;">
                ...
                <input type="checkbox" name="status" value="1" {{ old('status', $product->status) ? 'checked' : '' }} style="margin-right: 0.5rem;">
                Active
            </label>

            <label class="checkbox-container" style="display: flex; align-items: center; cursor: pointer;">
                <input type="hidden" name="is_exportable" value="0">
                <input type="checkbox" name="is_exportable" value="1" {{ old('is_exportable', $product->is_exportable) ? 'checked' : '' }} style="margin-right: 0.5rem;">
                Exportable
            </label>
        </div>

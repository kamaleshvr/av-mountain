...
<div class="glass-card" style="max-width: 600px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%; position: relative; z-index: 50;">Create Category</button>
    </form>
</div>
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    // Update preview
                    // Assuming AlpineJS context handles preview via x-data, but if not:
                    // document.querySelector('img[alt="Preview"]').src = dataUrl;
                }
            }
